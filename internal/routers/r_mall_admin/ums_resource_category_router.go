...
//	@Accept			json
//	@Produce		json
//	@Param			request	body	admin_dto.UmsResourceCategoryCreateDTO	true	"添加后台资源分类"
...
func (router *UmsResourceCategoryRouter) create(context *gin.Context) {
	var dto admin_dto.UmsResourceCategoryCreateDTO
...
//	@Param			request	body	admin_dto.UmsResourceCategoryCreateDTO	true	"修改后台资源分类"
//	@Security		GinJWTMiddleware
//	@Success		200	{object}	gin_common.GinCommonResponse
